    ...
    <footer style={{ background: 'var(--ink)', color: 'var(--cream)' }}>
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-3">
        <div>
          <div className="flex items-baseline gap-1">
            <span className="font-script text-4xl" style={{ color: 'var(--gold)' }}>café</span>
            <span className="font-display text-3xl">Eternal</span>
          </div>
      ...
      <div className="border-t" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
        <p className="mx-auto max-w-7xl px-6 py-5 text-center text-xs" style={{ color: 'rgba(245,235,221,0.5)' }}>
          © 2025 Café Eternal. All rights reserved.
        </p>
      </div>
    </footer>
  )
